...
nameIDs = pandas.read_csv(savePath, delimiter=',', header=None, index_col=0, names=['id','name'])
...
while True:
	...
	for (x, y, w, h) in faces:
		...
		cv2.putText(frame, str(conf), (x+5,y+h-5), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,255,0), 1)
